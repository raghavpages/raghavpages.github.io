...
![Example1And](/assets/images/logic/Example1And.jpg)
In the above example, in order for the bulb to light up, we need to close both the switches. 
![Example2And](/assets/images/logic/Example2And.jpg)
